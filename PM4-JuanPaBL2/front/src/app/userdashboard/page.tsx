                ...
                <div className="flex h-screen font-encode-sans-expanded">
                    ...
                    <main className="flex-1 bg-customGray text-center">
                        ...
                        <div className="flex flex-col space-y-6 px-6">
                            {/* Tarjeta 1 */}
                            <div onClick={toPersonalInfo} className="bg-white shadow-md rounded-lg p-6 flex items-center space-x-4 cursor-pointer">
                                ...
                                <div className="text-left">
                                    <h3 className="text-xl font-bold">Informacion personal</h3>
                                    <span className="text-gray-500">Correo electrónico, Credenciales, Etc.</span>
                                </div>
                            </div>
                            {/* Tarjeta 2 */}
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="text-left">
                                            ...
                                            <span className="text-gray-500">Configuraciones de la seguridad de tu cuenta.</span>
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="text-left">
                                            ...
                                            <span className="text-gray-500">Tarjetas guardadas en tu cuenta.</span>
                                        </div>
                                    </div>
                                    {/* Agregar más filas según sea necesario */}
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="text-left">
                                            ...
                                            <span className="text-gray-500">Direcciones guardadas en tu cuenta.</span>
                                        </div>
                                    </div>
                                    {/* Agregar más filas según sea necesario */}
                                </div>
